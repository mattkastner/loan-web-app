...
const ContactAgent = () => {
    return (
        <div className="container">
            <div className="crossDiv"><img src={cross} /></div>
            ...
            <br />
            <div className="userDiv">
                <textarea class="FieldTextArea" rows="3" cols="24" placeholder="Call me at your earliest convience, I would like to discuss officially applying for a loan.">

...
module.exports = function(req, res, next) {
    try {
        var params = req.query,
            ...
            url =
            "https://spreadsheets.google.com/feeds/list/1KihSE1tDd_UMeaBl5fUsZmUHbYek2JpzYw1h7eoakbg/1/public/values?alt=json";
        ...
        request(url, function(error, response, body) {
            if (!error && response.statusCode === 200) {
                ...
                return res
                    .status(200)
                    .json("No entries returned. Do you have the right ID?");
            }
        });
    } catch (error) {
